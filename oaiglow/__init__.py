...
if localConfig.OAIGLOW_APP_PREFIX_USE:
	logging.debug("wrapping oaiglow for reverse proxy with prefix '%s'" % localConfig.OAIGLOW_APP_PREFIX)
...
# init database
'''
key off `DB_TYPE` setting from localConfig
'''
# sqlite
if localConfig.DB_TYPE == 'sqlite':
	db = peewee.SqliteDatabase('oaiglow.db')
# MySQL
if localConfig.DB_TYPE == 'mysql':
	db = peewee.MySQLDatabase(localConfig.DB_MYSQL_DATABASE, user=localConfig.DB_MYSQL_USERNAME, password=localConfig.DB_MYSQL_PASSWORD, charset='utf8mb4')
